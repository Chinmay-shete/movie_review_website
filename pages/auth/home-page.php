...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-auth">
            <a href="../home/sign in.php" class="btn-login">Login</a>
            <a href="../home/sign up.php" class="btn-signup">Sign Up</a>
        </div>
        <!-- Mobile hamburger -->
    ...
    <div class="mobile-nav" id="mobileNav">
        ...
        <ul>
            ...
            <li><a href="../home/sign in.php">Login</a></li>
            <li><a href="../home/sign up.php">Sign Up</a></li>
        </ul>
    </div>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="../home/sign in.php" class="btn-trailer">
                    <span class="play-icon">&#9654;</span> Watch Trailer
                </a>
                <a href="../home/sign in.php" class="btn-review">
                    Read Review &rarr;
                </a>
            </div>
